    ...
    private var defaultProviderSection: some View {
        Section {
            Picker(selection: Binding(
                ...
                Text("默认 Provider").settingsItemTitle()
            }
...
struct AIProviderCard: View {
    ...
    var body: some View {
        DisclosureGroup(isExpanded: $isExpanded) {
            ...
            HStack(spacing: 6) {
                Text(provider.displayName).settingsItemTitle()
    ...
    private var endpointDisclosure: some View {
        DisclosureGroup(isExpanded: $endpointExpanded) {
            VStack(alignment: .leading, spacing: 4) {
            ...
            Text("高级：Endpoint")
                ...
                .contentShape(Rectangle())
                .onTapGesture { withAnimation { endpointExpanded.toggle() } }
        }
    }
