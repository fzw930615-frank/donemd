...
# Match on the executable path (Contents/MacOS/donemd — stays ASCII via
# EXECUTABLE_NAME) rather than the .app wrapper, whose name is now 马上做完.app.
pkill -9 -f "Contents/MacOS/donemd" 2>/dev/null || true
sleep 0.3
